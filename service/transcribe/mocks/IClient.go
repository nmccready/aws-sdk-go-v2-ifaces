...
// UpdateLanguageModel provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateLanguageModel(ctx context.Context, params *transcribe.UpdateLanguageModelInput, optFns ...func(*transcribe.Options)) (*transcribe.UpdateLanguageModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateLanguageModel")
	}

	var r0 *transcribe.UpdateLanguageModelOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *transcribe.UpdateLanguageModelInput, ...func(*transcribe.Options)) (*transcribe.UpdateLanguageModelOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *transcribe.UpdateLanguageModelInput, ...func(*transcribe.Options)) *transcribe.UpdateLanguageModelOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*transcribe.UpdateLanguageModelOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *transcribe.UpdateLanguageModelInput, ...func(*transcribe.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
