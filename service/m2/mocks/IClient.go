...
// CreateDataSetExportTask provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) CreateDataSetExportTask(ctx context.Context, params *m2.CreateDataSetExportTaskInput, optFns ...func(*m2.Options)) (*m2.CreateDataSetExportTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateDataSetExportTask")
	}

	var r0 *m2.CreateDataSetExportTaskOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *m2.CreateDataSetExportTaskInput, ...func(*m2.Options)) (*m2.CreateDataSetExportTaskOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *m2.CreateDataSetExportTaskInput, ...func(*m2.Options)) *m2.CreateDataSetExportTaskOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*m2.CreateDataSetExportTaskOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *m2.CreateDataSetExportTaskInput, ...func(*m2.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetDataSetExportTask provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetDataSetExportTask(ctx context.Context, params *m2.GetDataSetExportTaskInput, optFns ...func(*m2.Options)) (*m2.GetDataSetExportTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetDataSetExportTask")
	}

	var r0 *m2.GetDataSetExportTaskOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *m2.GetDataSetExportTaskInput, ...func(*m2.Options)) (*m2.GetDataSetExportTaskOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *m2.GetDataSetExportTaskInput, ...func(*m2.Options)) *m2.GetDataSetExportTaskOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*m2.GetDataSetExportTaskOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *m2.GetDataSetExportTaskInput, ...func(*m2.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// ListDataSetExportHistory provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListDataSetExportHistory(ctx context.Context, params *m2.ListDataSetExportHistoryInput, optFns ...func(*m2.Options)) (*m2.ListDataSetExportHistoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListDataSetExportHistory")
	}

	var r0 *m2.ListDataSetExportHistoryOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *m2.ListDataSetExportHistoryInput, ...func(*m2.Options)) (*m2.ListDataSetExportHistoryOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *m2.ListDataSetExportHistoryInput, ...func(*m2.Options)) *m2.ListDataSetExportHistoryOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*m2.ListDataSetExportHistoryOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *m2.ListDataSetExportHistoryInput, ...func(*m2.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
