...
// GetGovCloudAccountInformation provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetGovCloudAccountInformation(ctx context.Context, params *account.GetGovCloudAccountInformationInput, optFns ...func(*account.Options)) (*account.GetGovCloudAccountInformationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGovCloudAccountInformation")
	}

	var r0 *account.GetGovCloudAccountInformationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *account.GetGovCloudAccountInformationInput, ...func(*account.Options)) (*account.GetGovCloudAccountInformationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *account.GetGovCloudAccountInformationInput, ...func(*account.Options)) *account.GetGovCloudAccountInformationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*account.GetGovCloudAccountInformationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *account.GetGovCloudAccountInformationInput, ...func(*account.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetPrimaryEmailUpdateStatus provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetPrimaryEmailUpdateStatus(ctx context.Context, params *account.GetPrimaryEmailUpdateStatusInput, optFns ...func(*account.Options)) (*account.GetPrimaryEmailUpdateStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPrimaryEmailUpdateStatus")
	}

	var r0 *account.GetPrimaryEmailUpdateStatusOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *account.GetPrimaryEmailUpdateStatusInput, ...func(*account.Options)) (*account.GetPrimaryEmailUpdateStatusOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *account.GetPrimaryEmailUpdateStatusInput, ...func(*account.Options)) *account.GetPrimaryEmailUpdateStatusOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*account.GetPrimaryEmailUpdateStatusOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *account.GetPrimaryEmailUpdateStatusInput, ...func(*account.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
