...
func (_m *IClient) SwitchoverGlobalCluster(ctx context.Context, params *neptune.SwitchoverGlobalClusterInput, optFns ...func(*neptune.Options)) (*neptune.SwitchoverGlobalClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *neptune.SwitchoverGlobalClusterOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *neptune.SwitchoverGlobalClusterInput, ...func(*neptune.Options)) (*neptune.SwitchoverGlobalClusterOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *neptune.SwitchoverGlobalClusterInput, ...func(*neptune.Options)) *neptune.SwitchoverGlobalClusterOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*neptune.SwitchoverGlobalClusterOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *neptune.SwitchoverGlobalClusterInput, ...func(*neptune.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
