...
type IClient interface {
 ...
 CreateMultiRegionEndpoint(ctx context.Context, params *CreateMultiRegionEndpointInput, optFns ...func(*Options)) (*CreateMultiRegionEndpointOutput, error) 
 CreateTenant(ctx context.Context, params *CreateTenantInput, optFns ...func(*Options)) (*CreateTenantOutput, error) 
 CreateTenantResourceAssociation(ctx context.Context, params *CreateTenantResourceAssociationInput, optFns ...func(*Options)) (*CreateTenantResourceAssociationOutput, error) 
 ...
 DeleteMultiRegionEndpoint(ctx context.Context, params *DeleteMultiRegionEndpointInput, optFns ...func(*Options)) (*DeleteMultiRegionEndpointOutput, error) 
 ...
 GetMultiRegionEndpoint(ctx context.Context, params *GetMultiRegionEndpointInput, optFns ...func(*Options)) (*GetMultiRegionEndpointOutput, error) 
 GetReputationEntity(ctx context.Context, params *GetReputationEntityInput, optFns ...func(*Options)) (*GetReputationEntityOutput, error) 
 ...
 GetTenant(ctx context.Context, params *GetTenantInput, optFns ...func(*Options)) (*GetTenantOutput, error) 
 ...
 ListMultiRegionEndpoints(ctx context.Context, params *ListMultiRegionEndpointsInput, optFns ...func(*Options)) (*ListMultiRegionEndpointsOutput, error) 
 ...
 ListReputationEntities(ctx context.Context, params *ListReputationEntitiesInput, optFns ...func(*Options)) (*ListReputationEntitiesOutput, error) 
 ListResourceTenants(ctx context.Context, params *ListResourceTenantsInput, optFns ...func(*Options)) (*ListResourceTenantsOutput, error) 
 ...
 ListTenantResources(ctx context.Context, params *ListTenantResourcesInput, optFns ...func(*Options)) (*ListTenantResourcesOutput, error) 
 ...
 UpdateReputationEntityCustomerManagedStatus(ctx context.Context, params *UpdateReputationEntityCustomerManagedStatusInput, optFns ...func(*Options)) (*UpdateReputationEntityCustomerManagedStatusOutput, error) 
 UpdateReputationEntityPolicy(ctx context.Context, params *UpdateReputationEntityPolicyInput, optFns ...func(*Options)) (*UpdateReputationEntityPolicyOutput, error) 
}
