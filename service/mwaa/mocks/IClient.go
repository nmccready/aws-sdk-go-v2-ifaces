...
// InvokeRestApi provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) InvokeRestApi(ctx context.Context, params *mwaa.InvokeRestApiInput, optFns ...func(*mwaa.Options)) (*mwaa.InvokeRestApiOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for InvokeRestApi")
	}

	var r0 *mwaa.InvokeRestApiOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *mwaa.InvokeRestApiInput, ...func(*mwaa.Options)) (*mwaa.InvokeRestApiOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *mwaa.InvokeRestApiInput, ...func(*mwaa.Options)) *mwaa.InvokeRestApiOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mwaa.InvokeRestApiOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *mwaa.InvokeRestApiInput, ...func(*mwaa.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
