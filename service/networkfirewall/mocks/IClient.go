...
// UpdateProxySettings provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateProxySettings(ctx context.Context, params *networkfirewall.UpdateProxySettingsInput, optFns ...func(*networkfirewall.Options)) (*networkfirewall.UpdateProxySettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateProxySettings")
	}

	var r0 *networkfirewall.UpdateProxySettingsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *networkfirewall.UpdateProxySettingsInput, ...func(*networkfirewall.Options)) (*networkfirewall.UpdateProxySettingsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *networkfirewall.UpdateProxySettingsInput, ...func(*networkfirewall.Options)) *networkfirewall.UpdateProxySettingsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*networkfirewall.UpdateProxySettingsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *networkfirewall.UpdateProxySettingsInput, ...func(*networkfirewall.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
