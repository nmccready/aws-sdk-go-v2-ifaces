...
func (_m *IClient) Options() qldbsession.Options {
	ret := _m.Called()
...
func (_m *IClient) SendCommand(ctx context.Context, params *qldbsession.SendCommandInput, optFns ...func(*qldbsession.Options)) (*qldbsession.SendCommandOutput, error) {
