...
// InvokeGuardrailChecks provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) InvokeGuardrailChecks(ctx context.Context, params *bedrockruntime.InvokeGuardrailChecksInput, optFns ...func(*bedrockruntime.Options)) (*bedrockruntime.InvokeGuardrailChecksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for InvokeGuardrailChecks")
	}

	var r0 *bedrockruntime.InvokeGuardrailChecksOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *bedrockruntime.InvokeGuardrailChecksInput, ...func(*bedrockruntime.Options)) (*bedrockruntime.InvokeGuardrailChecksOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *bedrockruntime.InvokeGuardrailChecksInput, ...func(*bedrockruntime.Options)) *bedrockruntime.InvokeGuardrailChecksOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*bedrockruntime.InvokeGuardrailChecksOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *bedrockruntime.InvokeGuardrailChecksInput, ...func(*bedrockruntime.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
