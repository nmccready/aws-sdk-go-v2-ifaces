...
// CheckDocumentAccess provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) CheckDocumentAccess(ctx context.Context, params *qbusiness.CheckDocumentAccessInput, optFns ...func(*qbusiness.Options)) (*qbusiness.CheckDocumentAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckDocumentAccess")
	}

	var r0 *qbusiness.CheckDocumentAccessOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *qbusiness.CheckDocumentAccessInput, ...func(*qbusiness.Options)) (*qbusiness.CheckDocumentAccessOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *qbusiness.CheckDocumentAccessInput, ...func(*qbusiness.Options)) *qbusiness.CheckDocumentAccessOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*qbusiness.CheckDocumentAccessOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *qbusiness.CheckDocumentAccessInput, ...func(*qbusiness.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateAnonymousWebExperienceUrl provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) CreateAnonymousWebExperienceUrl(ctx context.Context, params *qbusiness.CreateAnonymousWebExperienceUrlInput, optFns ...func(*qbusiness.Options)) (*qbusiness.CreateAnonymousWebExperienceUrlOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateAnonymousWebExperienceUrl")
	}

	var r0 *qbusiness.CreateAnonymousWebExperienceUrlOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *qbusiness.CreateAnonymousWebExperienceUrlInput, ...func(*qbusiness.Options)) (*qbusiness.CreateAnonymousWebExperienceUrlOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *qbusiness.CreateAnonymousWebExperienceUrlInput, ...func(*qbusiness.Options)) *qbusiness.CreateAnonymousWebExperienceUrlOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*qbusiness.CreateAnonymousWebExperienceUrlOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *qbusiness.CreateAnonymousWebExperienceUrlInput, ...func(*qbusiness.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
