...
type IClient interface {
 ...
 CreatePrivateConnectivityConfig(ctx context.Context, params *CreatePrivateConnectivityConfigInput, optFns ...func(*Options)) (*CreatePrivateConnectivityConfigOutput, error) 
 CreateQuote(ctx context.Context, params *CreateQuoteInput, optFns ...func(*Options)) (*CreateQuoteOutput, error) 
 CreateRenewal(ctx context.Context, params *CreateRenewalInput, optFns ...func(*Options)) (*CreateRenewalOutput, error) 
 ...
 DeleteQuote(ctx context.Context, params *DeleteQuoteInput, optFns ...func(*Options)) (*DeleteQuoteOutput, error) 
 ...
 GetPrivateConnectivityConfig(ctx context.Context, params *GetPrivateConnectivityConfigInput, optFns ...func(*Options)) (*GetPrivateConnectivityConfigOutput, error) 
 GetQuote(ctx context.Context, params *GetQuoteInput, optFns ...func(*Options)) (*GetQuoteOutput, error) 
 GetRenewalPricing(ctx context.Context, params *GetRenewalPricingInput, optFns ...func(*Options)) (*GetRenewalPricingOutput, error) 
 ...
 ListOrderableInstanceTypes(ctx context.Context, params *ListOrderableInstanceTypesInput, optFns ...func(*Options)) (*ListOrderableInstanceTypesOutput, error) 
 ...
 ListQuotes(ctx context.Context, params *ListQuotesInput, optFns ...func(*Options)) (*ListQuotesOutput, error) 
 ...
 UpdateQuote(ctx context.Context, params *UpdateQuoteInput, optFns ...func(*Options)) (*UpdateQuoteOutput, error) 
