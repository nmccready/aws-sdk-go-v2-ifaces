...
type IClient interface {
 ...
 GetAutoshiftObserverNotificationStatus(ctx context.Context, params *GetAutoshiftObserverNotificationStatusInput, optFns ...func(*Options)) (*GetAutoshiftObserverNotificationStatusOutput, error) 
