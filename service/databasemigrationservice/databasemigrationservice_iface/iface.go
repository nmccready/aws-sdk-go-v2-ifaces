...
type IClient interface {
 ...
 CancelMetadataModelConversion(ctx context.Context, params *CancelMetadataModelConversionInput, optFns ...func(*Options)) (*CancelMetadataModelConversionOutput, error) 
 CancelMetadataModelCreation(ctx context.Context, params *CancelMetadataModelCreationInput, optFns ...func(*Options)) (*CancelMetadataModelCreationOutput, error) 
 ...
 DescribeMetadataModel(ctx context.Context, params *DescribeMetadataModelInput, optFns ...func(*Options)) (*DescribeMetadataModelOutput, error) 
 ...
 DescribeMetadataModelChildren(ctx context.Context, params *DescribeMetadataModelChildrenInput, optFns ...func(*Options)) (*DescribeMetadataModelChildrenOutput, error) 
 ...
 DescribeMetadataModelCreations(ctx context.Context, params *DescribeMetadataModelCreationsInput, optFns ...func(*Options)) (*DescribeMetadataModelCreationsOutput, error) 
 ...
 GetTargetSelectionRules(ctx context.Context, params *GetTargetSelectionRulesInput, optFns ...func(*Options)) (*GetTargetSelectionRulesOutput, error) 
 ...
 StartMetadataModelCreation(ctx context.Context, params *StartMetadataModelCreationInput, optFns ...func(*Options)) (*StartMetadataModelCreationOutput, error) 
