...
type IClient interface {
 ...
 AssociateSourceToS3TableIntegration(ctx context.Context, params *AssociateSourceToS3TableIntegrationInput, optFns ...func(*Options)) (*AssociateSourceToS3TableIntegrationOutput, error) 
 ...
 CreateImportTask(ctx context.Context, params *CreateImportTaskInput, optFns ...func(*Options)) (*CreateImportTaskOutput, error) 
 ...
 CreateLookupTable(ctx context.Context, params *CreateLookupTableInput, optFns ...func(*Options)) (*CreateLookupTableOutput, error) 
 ...
 DeleteLookupTable(ctx context.Context, params *DeleteLookupTableInput, optFns ...func(*Options)) (*DeleteLookupTableOutput, error) 
 ...
 DeleteSyslogConfiguration(ctx context.Context, params *DeleteSyslogConfigurationInput, optFns ...func(*Options)) (*DeleteSyslogConfigurationOutput, error) 
 ...
 DescribeImportTaskBatches(ctx context.Context, params *DescribeImportTaskBatchesInput, optFns ...func(*Options)) (*DescribeImportTaskBatchesOutput, error) 
 ...
 DescribeLookupTables(ctx context.Context, params *DescribeLookupTablesInput, optFns ...func(*Options)) (*DescribeLookupTablesOutput, error) 
 ...
 DisassociateSourceFromS3TableIntegration(ctx context.Context, params *DisassociateSourceFromS3TableIntegrationInput, optFns ...func(*Options)) (*DisassociateSourceFromS3TableIntegrationOutput, error) 
 ...
 GetLogFields(ctx context.Context, params *GetLogFieldsInput, optFns ...func(*Options)) (*GetLogFieldsOutput, error) 
 ...
 GetLookupTable(ctx context.Context, params *GetLookupTableInput, optFns ...func(*Options)) (*GetLookupTableOutput, error) 
 GetQueryResults(ctx context.Context, params *GetQueryResultsInput, optFns ...func(*Options)) (*GetQueryResultsOutput, error) 
 GetScheduledQuery(ctx context.Context, params *GetScheduledQueryInput, optFns ...func(*Options)) (*GetScheduledQueryOutput, error) 
 GetScheduledQueryHistory(ctx context.Context, params *GetScheduledQueryHistoryInput, optFns ...func(*Options)) (*GetScheduledQueryHistoryOutput, error) 
 GetStorageTierPolicy(ctx context.Context, params *GetStorageTierPolicyInput, optFns ...func(*Options)) (*GetStorageTierPolicyOutput, error) 
 GetTransformer(ctx context.Context, params *GetTransformerInput, optFns ...func(*Options)) (*GetTransformerOutput, error) 
 ListAggregateLogGroupSummaries(ctx context.Context, params *ListAggregateLogGroupSummariesInput, optFns ...func(*Options)) (*ListAggregateLogGroupSummariesOutput, error) 
 ...
 ListSourcesForS3TableIntegration(ctx context.Context, params *ListSourcesForS3TableIntegrationInput, optFns ...func(*Options)) (*ListSourcesForS3TableIntegrationOutput, error) 
 ListSyslogConfigurations(ctx context.Context, params *ListSyslogConfigurationsInput, optFns ...func(*Options)) (*ListSyslogConfigurationsOutput, error) 
 ...
 PutStorageTierPolicy(ctx context.Context, params *PutStorageTierPolicyInput, optFns ...func(*Options)) (*PutStorageTierPolicyOutput, error) 
 ...
 PutSyslogConfiguration(ctx context.Context, params *PutSyslogConfigurationInput, optFns ...func(*Options)) (*PutSyslogConfigurationOutput, error) 
 ...
 UpdateLookupTable(ctx context.Context, params *UpdateLookupTableInput, optFns ...func(*Options)) (*UpdateLookupTableOutput, error) 
