...
// StartApprovalTeamBaseline provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) StartApprovalTeamBaseline(ctx context.Context, params *mpa.StartApprovalTeamBaselineInput, optFns ...func(*mpa.Options)) (*mpa.StartApprovalTeamBaselineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for StartApprovalTeamBaseline")
	}

	var r0 *mpa.StartApprovalTeamBaselineOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *mpa.StartApprovalTeamBaselineInput, ...func(*mpa.Options)) (*mpa.StartApprovalTeamBaselineOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *mpa.StartApprovalTeamBaselineInput, ...func(*mpa.Options)) *mpa.StartApprovalTeamBaselineOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpa.StartApprovalTeamBaselineOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *mpa.StartApprovalTeamBaselineInput, ...func(*mpa.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
