...
func (_m *IClient) GetAccessToken(ctx context.Context, params *ssm.GetAccessTokenInput, optFns ...func(*ssm.Options)) (*ssm.GetAccessTokenOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IClient) StartAccessRequest(ctx context.Context, params *ssm.StartAccessRequestInput, optFns ...func(*ssm.Options)) (*ssm.StartAccessRequestOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
