...
type IClient interface {
 ...
 CreateMultiRegionCluster(ctx context.Context, params *CreateMultiRegionClusterInput, optFns ...func(*Options)) (*CreateMultiRegionClusterOutput, error) 
 ...
 DeleteMultiRegionCluster(ctx context.Context, params *DeleteMultiRegionClusterInput, optFns ...func(*Options)) (*DeleteMultiRegionClusterOutput, error) 
 ...
 ListAllowedMultiRegionClusterUpdates(ctx context.Context, params *ListAllowedMultiRegionClusterUpdatesInput, optFns ...func(*Options)) (*ListAllowedMultiRegionClusterUpdatesOutput, error) 
 ...
 UpdateMultiRegionCluster(ctx context.Context, params *UpdateMultiRegionClusterInput, optFns ...func(*Options)) (*UpdateMultiRegionClusterOutput, error) 
