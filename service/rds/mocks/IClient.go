...
// DescribeDBMajorEngineVersions provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) DescribeDBMajorEngineVersions(ctx context.Context, params *rds.DescribeDBMajorEngineVersionsInput, optFns ...func(*rds.Options)) (*rds.DescribeDBMajorEngineVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for DescribeDBMajorEngineVersions")
	}

	var r0 *rds.DescribeDBMajorEngineVersionsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *rds.DescribeDBMajorEngineVersionsInput, ...func(*rds.Options)) (*rds.DescribeDBMajorEngineVersionsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *rds.DescribeDBMajorEngineVersionsInput, ...func(*rds.Options)) *rds.DescribeDBMajorEngineVersionsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rds.DescribeDBMajorEngineVersionsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *rds.DescribeDBMajorEngineVersionsInput, ...func(*rds.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
