...
type IClient interface {
 Options() Options 
 AcceptDataGrant(ctx context.Context, params *AcceptDataGrantInput, optFns ...func(*Options)) (*AcceptDataGrantOutput, error) 
 CancelJob(ctx context.Context, params *CancelJobInput, optFns ...func(*Options)) (*CancelJobOutput, error) 
 CreateDataGrant(ctx context.Context, params *CreateDataGrantInput, optFns ...func(*Options)) (*CreateDataGrantOutput, error) 
 ...
 DeleteDataGrant(ctx context.Context, params *DeleteDataGrantInput, optFns ...func(*Options)) (*DeleteDataGrantOutput, error) 
 ...
 GetDataGrant(ctx context.Context, params *GetDataGrantInput, optFns ...func(*Options)) (*GetDataGrantOutput, error) 
 ...
 GetReceivedDataGrant(ctx context.Context, params *GetReceivedDataGrantInput, optFns ...func(*Options)) (*GetReceivedDataGrantOutput, error) 
 GetRevision(ctx context.Context, params *GetRevisionInput, optFns ...func(*Options)) (*GetRevisionOutput, error) 
 ListDataGrants(ctx context.Context, params *ListDataGrantsInput, optFns ...func(*Options)) (*ListDataGrantsOutput, error) 
 ...
 ListReceivedDataGrants(ctx context.Context, params *ListReceivedDataGrantsInput, optFns ...func(*Options)) (*ListReceivedDataGrantsOutput, error) 
