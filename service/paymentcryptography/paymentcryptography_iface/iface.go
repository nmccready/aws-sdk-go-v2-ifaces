...
package paymentcryptography_iface
...
type IClient interface {
 ...
 AssociateMpaTeam(ctx context.Context, params *AssociateMpaTeamInput, optFns ...func(*Options)) (*AssociateMpaTeamOutput, error) 
 ...
 DisassociateMpaTeam(ctx context.Context, params *DisassociateMpaTeamInput, optFns ...func(*Options)) (*DisassociateMpaTeamOutput, error) 
 ...
 GetMpaTeamAssociation(ctx context.Context, params *GetMpaTeamAssociationInput, optFns ...func(*Options)) (*GetMpaTeamAssociationOutput, error) 
