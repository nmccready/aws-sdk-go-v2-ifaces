...
// SearchCertificates provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) SearchCertificates(ctx context.Context, params *acm.SearchCertificatesInput, optFns ...func(*acm.Options)) (*acm.SearchCertificatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for SearchCertificates")
	}

	var r0 *acm.SearchCertificatesOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *acm.SearchCertificatesInput, ...func(*acm.Options)) (*acm.SearchCertificatesOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *acm.SearchCertificatesInput, ...func(*acm.Options)) *acm.SearchCertificatesOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*acm.SearchCertificatesOutput)
		}
	}
