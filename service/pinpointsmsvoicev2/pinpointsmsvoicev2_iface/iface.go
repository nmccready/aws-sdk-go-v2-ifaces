...
type IClient interface {
 ...
 CreateNotifyConfiguration(ctx context.Context, params *CreateNotifyConfigurationInput, optFns ...func(*Options)) (*CreateNotifyConfigurationOutput, error) 
 ...
 CreateRcsAgent(ctx context.Context, params *CreateRcsAgentInput, optFns ...func(*Options)) (*CreateRcsAgentOutput, error) 
 ...
 DeleteNotifyConfiguration(ctx context.Context, params *DeleteNotifyConfigurationInput, optFns ...func(*Options)) (*DeleteNotifyConfigurationOutput, error) 
 DeleteNotifyMessageSpendLimitOverride(ctx context.Context, params *DeleteNotifyMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*DeleteNotifyMessageSpendLimitOverrideOutput, error) 
 ...
 DeleteRcsAgent(ctx context.Context, params *DeleteRcsAgentInput, optFns ...func(*Options)) (*DeleteRcsAgentOutput, error) 
 DeleteRcsMessageSpendLimitOverride(ctx context.Context, params *DeleteRcsMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*DeleteRcsMessageSpendLimitOverrideOutput, error) 
 ...
 DescribeNotifyConfigurations(ctx context.Context, params *DescribeNotifyConfigurationsInput, optFns ...func(*Options)) (*DescribeNotifyConfigurationsOutput, error) 
 DescribeNotifyTemplates(ctx context.Context, params *DescribeNotifyTemplatesInput, optFns ...func(*Options)) (*DescribeNotifyTemplatesOutput, error) 
 ...
 DescribeRcsAgentCountryLaunchStatus(ctx context.Context, params *DescribeRcsAgentCountryLaunchStatusInput, optFns ...func(*Options)) (*DescribeRcsAgentCountryLaunchStatusOutput, error) 
 DescribeRcsAgents(ctx context.Context, params *DescribeRcsAgentsInput, optFns ...func(*Options)) (*DescribeRcsAgentsOutput, error) 
 ...
 SendNotifyTextMessage(ctx context.Context, params *SendNotifyTextMessageInput, optFns ...func(*Options)) (*SendNotifyTextMessageOutput, error) 
 SendNotifyVoiceMessage(ctx context.Context, params *SendNotifyVoiceMessageInput, optFns ...func(*Options)) (*SendNotifyVoiceMessageOutput, error) 
 SendRcsMessage(ctx context.Context, params *SendRcsMessageInput, optFns ...func(*Options)) (*SendRcsMessageOutput, error) 
 ...
 SetNotifyMessageSpendLimitOverride(ctx context.Context, params *SetNotifyMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*SetNotifyMessageSpendLimitOverrideOutput, error) 
 SetRcsMessageSpendLimitOverride(ctx context.Context, params *SetRcsMessageSpendLimitOverrideInput, optFns ...func(*Options)) (*SetRcsMessageSpendLimitOverrideOutput, error) 
 ...
 UpdateNotifyConfiguration(ctx context.Context, params *UpdateNotifyConfigurationInput, optFns ...func(*Options)) (*UpdateNotifyConfigurationOutput, error) 
 ...
 UpdateRcsAgent(ctx context.Context, params *UpdateRcsAgentInput, optFns ...func(*Options)) (*UpdateRcsAgentOutput, error) 
