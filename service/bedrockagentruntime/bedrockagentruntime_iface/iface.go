...
type IClient interface {
 ...
 ListFlowExecutionEvents(ctx context.Context, params *ListFlowExecutionEventsInput, optFns ...func(*Options)) (*ListFlowExecutionEventsOutput, error) 
 ListFlowExecutions(ctx context.Context, params *ListFlowExecutionsInput, optFns ...func(*Options)) (*ListFlowExecutionsOutput, error) 
 ...
 StartFlowExecution(ctx context.Context, params *StartFlowExecutionInput, optFns ...func(*Options)) (*StartFlowExecutionOutput, error) 
 StopFlowExecution(ctx context.Context, params *StopFlowExecutionInput, optFns ...func(*Options)) (*StopFlowExecutionOutput, error) 
