...
type IClient interface {
 ...
 GetRevenueStatistics(ctx context.Context, params *GetRevenueStatisticsInput, optFns ...func(*Options)) (*GetRevenueStatisticsOutput, error) 
 GetRevenueStatisticsSummary(ctx context.Context, params *GetRevenueStatisticsSummaryInput, optFns ...func(*Options)) (*GetRevenueStatisticsSummaryOutput, error) 
 GetRevenueStatisticsTimeSeries(ctx context.Context, params *GetRevenueStatisticsTimeSeriesInput, optFns ...func(*Options)) (*GetRevenueStatisticsTimeSeriesOutput, error) 
 ...
 ListSettlementRecords(ctx context.Context, params *ListSettlementRecordsInput, optFns ...func(*Options)) (*ListSettlementRecordsOutput, error) 
