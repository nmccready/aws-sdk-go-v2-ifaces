...
func (_m *IClient) DeleteConfiguration(ctx context.Context, params *mq.DeleteConfigurationInput, optFns ...func(*mq.Options)) (*mq.DeleteConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *mq.DeleteConfigurationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *mq.DeleteConfigurationInput, ...func(*mq.Options)) (*mq.DeleteConfigurationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *mq.DeleteConfigurationInput, ...func(*mq.Options)) *mq.DeleteConfigurationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mq.DeleteConfigurationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *mq.DeleteConfigurationInput, ...func(*mq.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
