...
// StopServiceDeployment provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) StopServiceDeployment(ctx context.Context, params *ecs.StopServiceDeploymentInput, optFns ...func(*ecs.Options)) (*ecs.StopServiceDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for StopServiceDeployment")
	}

	var r0 *ecs.StopServiceDeploymentOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ecs.StopServiceDeploymentInput, ...func(*ecs.Options)) (*ecs.StopServiceDeploymentOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ecs.StopServiceDeploymentInput, ...func(*ecs.Options)) *ecs.StopServiceDeploymentOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ecs.StopServiceDeploymentOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *ecs.StopServiceDeploymentInput, ...func(*ecs.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
