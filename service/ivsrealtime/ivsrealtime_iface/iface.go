...
type IClient interface {
 ...
 ListParticipantReplicas(ctx context.Context, params *ListParticipantReplicasInput, optFns ...func(*Options)) (*ListParticipantReplicasOutput, error) 
 ...
 StartParticipantReplication(ctx context.Context, params *StartParticipantReplicationInput, optFns ...func(*Options)) (*StartParticipantReplicationOutput, error) 
 StopComposition(ctx context.Context, params *StopCompositionInput, optFns ...func(*Options)) (*StopCompositionOutput, error) 
 StopParticipantReplication(ctx context.Context, params *StopParticipantReplicationInput, optFns ...func(*Options)) (*StopParticipantReplicationOutput, error) 
