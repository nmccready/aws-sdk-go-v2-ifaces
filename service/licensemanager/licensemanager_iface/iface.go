...
type IClient interface {
 ...
 CreateLicenseAssetGroup(ctx context.Context, params *CreateLicenseAssetGroupInput, optFns ...func(*Options)) (*CreateLicenseAssetGroupOutput, error) 
 CreateLicenseAssetRuleset(ctx context.Context, params *CreateLicenseAssetRulesetInput, optFns ...func(*Options)) (*CreateLicenseAssetRulesetOutput, error) 
 ...
 DeleteLicenseAssetGroup(ctx context.Context, params *DeleteLicenseAssetGroupInput, optFns ...func(*Options)) (*DeleteLicenseAssetGroupOutput, error) 
 DeleteLicenseAssetRuleset(ctx context.Context, params *DeleteLicenseAssetRulesetInput, optFns ...func(*Options)) (*DeleteLicenseAssetRulesetOutput, error) 
 ...
 GetLicenseAssetGroup(ctx context.Context, params *GetLicenseAssetGroupInput, optFns ...func(*Options)) (*GetLicenseAssetGroupOutput, error) 
 GetLicenseAssetRuleset(ctx context.Context, params *GetLicenseAssetRulesetInput, optFns ...func(*Options)) (*GetLicenseAssetRulesetOutput, error) 
 ...
 ListAssetsForLicenseAssetGroup(ctx context.Context, params *ListAssetsForLicenseAssetGroupInput, optFns ...func(*Options)) (*ListAssetsForLicenseAssetGroupOutput, error) 
 ...
 ListLicenseAssetGroups(ctx context.Context, params *ListLicenseAssetGroupsInput, optFns ...func(*Options)) (*ListLicenseAssetGroupsOutput, error) 
 ListLicenseAssetRulesets(ctx context.Context, params *ListLicenseAssetRulesetsInput, optFns ...func(*Options)) (*ListLicenseAssetRulesetsOutput, error) 
 ...
 ListLicenseConfigurationsForOrganization(ctx context.Context, params *ListLicenseConfigurationsForOrganizationInput, optFns ...func(*Options)) (*ListLicenseConfigurationsForOrganizationOutput, error) 
 ...
 UpdateLicenseAssetGroup(ctx context.Context, params *UpdateLicenseAssetGroupInput, optFns ...func(*Options)) (*UpdateLicenseAssetGroupOutput, error) 
 UpdateLicenseAssetRuleset(ctx context.Context, params *UpdateLicenseAssetRulesetInput, optFns ...func(*Options)) (*UpdateLicenseAssetRulesetOutput, error) 
