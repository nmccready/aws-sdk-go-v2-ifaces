...
// UpdateHostedZoneFeatures provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateHostedZoneFeatures(ctx context.Context, params *route53.UpdateHostedZoneFeaturesInput, optFns ...func(*route53.Options)) (*route53.UpdateHostedZoneFeaturesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateHostedZoneFeatures")
	}

	var r0 *route53.UpdateHostedZoneFeaturesOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *route53.UpdateHostedZoneFeaturesInput, ...func(*route53.Options)) (*route53.UpdateHostedZoneFeaturesOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *route53.UpdateHostedZoneFeaturesInput, ...func(*route53.Options)) *route53.UpdateHostedZoneFeaturesOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*route53.UpdateHostedZoneFeaturesOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *route53.UpdateHostedZoneFeaturesInput, ...func(*route53.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
