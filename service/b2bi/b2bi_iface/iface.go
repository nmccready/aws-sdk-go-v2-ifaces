...
type IClient interface {
 ...
 CreateStarterMappingTemplate(ctx context.Context, params *CreateStarterMappingTemplateInput, optFns ...func(*Options)) (*CreateStarterMappingTemplateOutput, error) 
 ...
 GenerateMapping(ctx context.Context, params *GenerateMappingInput, optFns ...func(*Options)) (*GenerateMappingOutput, error) 
 ...
 TestConversion(ctx context.Context, params *TestConversionInput, optFns ...func(*Options)) (*TestConversionOutput, error) 
