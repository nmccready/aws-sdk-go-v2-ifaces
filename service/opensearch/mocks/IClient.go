...
// RollbackServiceSoftwareUpdate provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) RollbackServiceSoftwareUpdate(ctx context.Context, params *opensearch.RollbackServiceSoftwareUpdateInput, optFns ...func(*opensearch.Options)) (*opensearch.RollbackServiceSoftwareUpdateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for RollbackServiceSoftwareUpdate")
	}

	var r0 *opensearch.RollbackServiceSoftwareUpdateOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *opensearch.RollbackServiceSoftwareUpdateInput, ...func(*opensearch.Options)) (*opensearch.RollbackServiceSoftwareUpdateOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *opensearch.RollbackServiceSoftwareUpdateInput, ...func(*opensearch.Options)) *opensearch.RollbackServiceSoftwareUpdateOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*opensearch.RollbackServiceSoftwareUpdateOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *opensearch.RollbackServiceSoftwareUpdateInput, ...func(*opensearch.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
