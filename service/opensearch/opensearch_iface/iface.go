...
type IClient interface {
 ...
 AttachDataSource(ctx context.Context, params *AttachDataSourceInput, optFns ...func(*Options)) (*AttachDataSourceOutput, error) 
 ...
 DeregisterCapability(ctx context.Context, params *DeregisterCapabilityInput, optFns ...func(*Options)) (*DeregisterCapabilityOutput, error) 
 DescribeDataSourceAttachment(ctx context.Context, params *DescribeDataSourceAttachmentInput, optFns ...func(*Options)) (*DescribeDataSourceAttachmentOutput, error) 
 ...
 DescribeInsightDetails(ctx context.Context, params *DescribeInsightDetailsInput, optFns ...func(*Options)) (*DescribeInsightDetailsOutput, error) 
 ...
 DetachDataSource(ctx context.Context, params *DetachDataSourceInput, optFns ...func(*Options)) (*DetachDataSourceOutput, error) 
 ...
 GetDefaultApplicationSetting(ctx context.Context, params *GetDefaultApplicationSettingInput, optFns ...func(*Options)) (*GetDefaultApplicationSettingOutput, error) 
 ...
 InsightFeedback(ctx context.Context, params *InsightFeedbackInput, optFns ...func(*Options)) (*InsightFeedbackOutput, error) 
 ListApplications(ctx context.Context, params *ListApplicationsInput, optFns ...func(*Options)) (*ListApplicationsOutput, error) 
 ListDataSourceAttachments(ctx context.Context, params *ListDataSourceAttachmentsInput, optFns ...func(*Options)) (*ListDataSourceAttachmentsOutput, error) 
 ...
 ListMigrations(ctx context.Context, params *ListMigrationsInput, optFns ...func(*Options)) (*ListMigrationsOutput, error) 
 ...
 PutDefaultApplicationSetting(ctx context.Context, params *PutDefaultApplicationSettingInput, optFns ...func(*Options)) (*PutDefaultApplicationSettingOutput, error) 
 RegisterCapability(ctx context.Context, params *RegisterCapabilityInput, optFns ...func(*Options)) (*RegisterCapabilityOutput, error) 
