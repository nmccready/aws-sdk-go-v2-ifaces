...
// AdminGetUserAuthFactors provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) AdminGetUserAuthFactors(ctx context.Context, params *cognitoidentityprovider.AdminGetUserAuthFactorsInput, optFns ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.AdminGetUserAuthFactorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for AdminGetUserAuthFactors")
	}

	var r0 *cognitoidentityprovider.AdminGetUserAuthFactorsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *cognitoidentityprovider.AdminGetUserAuthFactorsInput, ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.AdminGetUserAuthFactorsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *cognitoidentityprovider.AdminGetUserAuthFactorsInput, ...func(*cognitoidentityprovider.Options)) *cognitoidentityprovider.AdminGetUserAuthFactorsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cognitoidentityprovider.AdminGetUserAuthFactorsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *cognitoidentityprovider.AdminGetUserAuthFactorsInput, ...func(*cognitoidentityprovider.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetTokensFromRefreshToken provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetTokensFromRefreshToken(ctx context.Context, params *cognitoidentityprovider.GetTokensFromRefreshTokenInput, optFns ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.GetTokensFromRefreshTokenOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTokensFromRefreshToken")
	}

	var r0 *cognitoidentityprovider.GetTokensFromRefreshTokenOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *cognitoidentityprovider.GetTokensFromRefreshTokenInput, ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.GetTokensFromRefreshTokenOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *cognitoidentityprovider.GetTokensFromRefreshTokenInput, ...func(*cognitoidentityprovider.Options)) *cognitoidentityprovider.GetTokensFromRefreshTokenOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cognitoidentityprovider.GetTokensFromRefreshTokenOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *cognitoidentityprovider.GetTokensFromRefreshTokenInput, ...func(*cognitoidentityprovider.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
