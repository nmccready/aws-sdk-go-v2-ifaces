...
type IClient interface {
 ...
 CreateNetworkMigrationDefinition(ctx context.Context, params *CreateNetworkMigrationDefinitionInput, optFns ...func(*Options)) (*CreateNetworkMigrationDefinitionOutput, error) 
 ...
 DeleteNetworkMigrationDefinition(ctx context.Context, params *DeleteNetworkMigrationDefinitionInput, optFns ...func(*Options)) (*DeleteNetworkMigrationDefinitionOutput, error) 
 ...
 GetNetworkMigrationDefinition(ctx context.Context, params *GetNetworkMigrationDefinitionInput, optFns ...func(*Options)) (*GetNetworkMigrationDefinitionOutput, error) 
 GetNetworkMigrationMapperSegmentConstruct(ctx context.Context, params *GetNetworkMigrationMapperSegmentConstructInput, optFns ...func(*Options)) (*GetNetworkMigrationMapperSegmentConstructOutput, error) 
 ...
 ListImportFileEnrichments(ctx context.Context, params *ListImportFileEnrichmentsInput, optFns ...func(*Options)) (*ListImportFileEnrichmentsOutput, error) 
 ...
 ListNetworkMigrationAnalyses(ctx context.Context, params *ListNetworkMigrationAnalysesInput, optFns ...func(*Options)) (*ListNetworkMigrationAnalysesOutput, error) 
 ListNetworkMigrationAnalysisResults(ctx context.Context, params *ListNetworkMigrationAnalysisResultsInput, optFns ...func(*Options)) (*ListNetworkMigrationAnalysisResultsOutput, error) 
 ListNetworkMigrationCodeGenerationSegments(ctx context.Context, params *ListNetworkMigrationCodeGenerationSegmentsInput, optFns ...func(*Options)) (*ListNetworkMigrationCodeGenerationSegmentsOutput, error) 
 ListNetworkMigrationCodeGenerations(ctx context.Context, params *ListNetworkMigrationCodeGenerationsInput, optFns ...func(*Options)) (*ListNetworkMigrationCodeGenerationsOutput, error) 
 ListNetworkMigrationDefinitions(ctx context.Context, params *ListNetworkMigrationDefinitionsInput, optFns ...func(*Options)) (*ListNetworkMigrationDefinitionsOutput, error) 
 ListNetworkMigrationDeployedStacks(ctx context.Context, params *ListNetworkMigrationDeployedStacksInput, optFns ...func(*Options)) (*ListNetworkMigrationDeployedStacksOutput, error) 
 ListNetworkMigrationDeployments(ctx context.Context, params *ListNetworkMigrationDeploymentsInput, optFns ...func(*Options)) (*ListNetworkMigrationDeploymentsOutput, error) 
 ListNetworkMigrationExecutions(ctx context.Context, params *ListNetworkMigrationExecutionsInput, optFns ...func(*Options)) (*ListNetworkMigrationExecutionsOutput, error) 
 ListNetworkMigrationMapperSegmentConstructs(ctx context.Context, params *ListNetworkMigrationMapperSegmentConstructsInput, optFns ...func(*Options)) (*ListNetworkMigrationMapperSegmentConstructsOutput, error) 
 ListNetworkMigrationMapperSegments(ctx context.Context, params *ListNetworkMigrationMapperSegmentsInput, optFns ...func(*Options)) (*ListNetworkMigrationMapperSegmentsOutput, error) 
 ListNetworkMigrationMappingUpdates(ctx context.Context, params *ListNetworkMigrationMappingUpdatesInput, optFns ...func(*Options)) (*ListNetworkMigrationMappingUpdatesOutput, error) 
 ListNetworkMigrationMappings(ctx context.Context, params *ListNetworkMigrationMappingsInput, optFns ...func(*Options)) (*ListNetworkMigrationMappingsOutput, error) 
 ...
 StartImportFileEnrichment(ctx context.Context, params *StartImportFileEnrichmentInput, optFns ...func(*Options)) (*StartImportFileEnrichmentOutput, error) 
 StartNetworkMigrationAnalysis(ctx context.Context, params *StartNetworkMigrationAnalysisInput, optFns ...func(*Options)) (*StartNetworkMigrationAnalysisOutput, error) 
 StartNetworkMigrationCodeGeneration(ctx context.Context, params *StartNetworkMigrationCodeGenerationInput, optFns ...func(*Options)) (*StartNetworkMigrationCodeGenerationOutput, error) 
 StartNetworkMigrationDeployment(ctx context.Context, params *StartNetworkMigrationDeploymentInput, optFns ...func(*Options)) (*StartNetworkMigrationDeploymentOutput, error) 
 StartNetworkMigrationMapping(ctx context.Context, params *StartNetworkMigrationMappingInput, optFns ...func(*Options)) (*StartNetworkMigrationMappingOutput, error) 
 StartNetworkMigrationMappingUpdate(ctx context.Context, params *StartNetworkMigrationMappingUpdateInput, optFns ...func(*Options)) (*StartNetworkMigrationMappingUpdateOutput, error) 
 ...
 UpdateNetworkMigrationDefinition(ctx context.Context, params *UpdateNetworkMigrationDefinitionInput, optFns ...func(*Options)) (*UpdateNetworkMigrationDefinitionOutput, error) 
 UpdateNetworkMigrationMapperSegment(ctx context.Context, params *UpdateNetworkMigrationMapperSegmentInput, optFns ...func(*Options)) (*UpdateNetworkMigrationMapperSegmentOutput, error) 
