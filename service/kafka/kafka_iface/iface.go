...
type IClient interface {
 ...
 DescribeTopicPartitions(ctx context.Context, params *DescribeTopicPartitionsInput, optFns ...func(*Options)) (*DescribeTopicPartitionsOutput, error) 
 ...
 UpdateRebalancing(ctx context.Context, params *UpdateRebalancingInput, optFns ...func(*Options)) (*UpdateRebalancingOutput, error) 
