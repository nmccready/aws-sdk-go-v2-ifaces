...
// GenerateMatchId provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GenerateMatchId(ctx context.Context, params *entityresolution.GenerateMatchIdInput, optFns ...func(*entityresolution.Options)) (*entityresolution.GenerateMatchIdOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GenerateMatchId")
	}

	var r0 *entityresolution.GenerateMatchIdOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *entityresolution.GenerateMatchIdInput, ...func(*entityresolution.Options)) (*entityresolution.GenerateMatchIdOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *entityresolution.GenerateMatchIdInput, ...func(*entityresolution.Options)) *entityresolution.GenerateMatchIdOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entityresolution.GenerateMatchIdOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *entityresolution.GenerateMatchIdInput, ...func(*entityresolution.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
