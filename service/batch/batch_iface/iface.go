...
type IClient interface {
 ...
 CreateQuotaShare(ctx context.Context, params *CreateQuotaShareInput, optFns ...func(*Options)) (*CreateQuotaShareOutput, error) 
 ...
 CreateServiceEnvironment(ctx context.Context, params *CreateServiceEnvironmentInput, optFns ...func(*Options)) (*CreateServiceEnvironmentOutput, error) 
 ...
 DeleteQuotaShare(ctx context.Context, params *DeleteQuotaShareInput, optFns ...func(*Options)) (*DeleteQuotaShareOutput, error) 
 ...
 DeleteServiceEnvironment(ctx context.Context, params *DeleteServiceEnvironmentInput, optFns ...func(*Options)) (*DeleteServiceEnvironmentOutput, error) 
 ...
 DescribeQuotaShare(ctx context.Context, params *DescribeQuotaShareInput, optFns ...func(*Options)) (*DescribeQuotaShareOutput, error) 
 ...
 DescribeServiceEnvironments(ctx context.Context, params *DescribeServiceEnvironmentsInput, optFns ...func(*Options)) (*DescribeServiceEnvironmentsOutput, error) 
 DescribeServiceJob(ctx context.Context, params *DescribeServiceJobInput, optFns ...func(*Options)) (*DescribeServiceJobOutput, error) 
 ...
 ListQuotaShares(ctx context.Context, params *ListQuotaSharesInput, optFns ...func(*Options)) (*ListQuotaSharesOutput, error) 
 ...
 ListServiceJobs(ctx context.Context, params *ListServiceJobsInput, optFns ...func(*Options)) (*ListServiceJobsOutput, error) 
 ...
 UpdateQuotaShare(ctx context.Context, params *UpdateQuotaShareInput, optFns ...func(*Options)) (*UpdateQuotaShareOutput, error) 
 ...
 UpdateServiceEnvironment(ctx context.Context, params *UpdateServiceEnvironmentInput, optFns ...func(*Options)) (*UpdateServiceEnvironmentOutput, error) 
 UpdateServiceJob(ctx context.Context, params *UpdateServiceJobInput, optFns ...func(*Options)) (*UpdateServiceJobOutput, error) 
}
