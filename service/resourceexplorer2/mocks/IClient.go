...
// GetManagedView provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetManagedView(ctx context.Context, params *resourceexplorer2.GetManagedViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetManagedViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetManagedView")
	}

	var r0 *resourceexplorer2.GetManagedViewOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.GetManagedViewInput, ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetManagedViewOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.GetManagedViewInput, ...func(*resourceexplorer2.Options)) *resourceexplorer2.GetManagedViewOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*resourceexplorer2.GetManagedViewOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *resourceexplorer2.GetManagedViewInput, ...func(*resourceexplorer2.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// ListManagedViews provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListManagedViews(ctx context.Context, params *resourceexplorer2.ListManagedViewsInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListManagedViewsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListManagedViews")
	}

	var r0 *resourceexplorer2.ListManagedViewsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.ListManagedViewsInput, ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListManagedViewsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.ListManagedViewsInput, ...func(*resourceexplorer2.Options)) *resourceexplorer2.ListManagedViewsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*resourceexplorer2.ListManagedViewsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *resourceexplorer2.ListManagedViewsInput, ...func(*resourceexplorer2.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IClient) ListResources(ctx context.Context, params *resourceexplorer2.ListResourcesInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *resourceexplorer2.ListResourcesOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.ListResourcesInput, ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListResourcesOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *resourceexplorer2.ListResourcesInput, ...func(*resourceexplorer2.Options)) *resourceexplorer2.ListResourcesOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*resourceexplorer2.ListResourcesOutput)
		}
	}
