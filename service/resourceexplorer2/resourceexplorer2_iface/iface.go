...
package resourceexplorer2_iface
...
type IClient interface {
 ...
 CreateResourceExplorerSetup(ctx context.Context, params *CreateResourceExplorerSetupInput, optFns ...func(*Options)) (*CreateResourceExplorerSetupOutput, error) 
 ...
 DeleteResourceExplorerSetup(ctx context.Context, params *DeleteResourceExplorerSetupInput, optFns ...func(*Options)) (*DeleteResourceExplorerSetupOutput, error) 
 ...
 GetManagedView(ctx context.Context, params *GetManagedViewInput, optFns ...func(*Options)) (*GetManagedViewOutput, error) 
 GetResourceExplorerSetup(ctx context.Context, params *GetResourceExplorerSetupInput, optFns ...func(*Options)) (*GetResourceExplorerSetupOutput, error) 
 GetServiceIndex(ctx context.Context, params *GetServiceIndexInput, optFns ...func(*Options)) (*GetServiceIndexOutput, error) 
 GetServiceView(ctx context.Context, params *GetServiceViewInput, optFns ...func(*Options)) (*GetServiceViewOutput, error) 
 ...
 ListManagedViews(ctx context.Context, params *ListManagedViewsInput, optFns ...func(*Options)) (*ListManagedViewsOutput, error) 
 ListResources(ctx context.Context, params *ListResourcesInput, optFns ...func(*Options)) (*ListResourcesOutput, error) 
 ListServiceIndexes(ctx context.Context, params *ListServiceIndexesInput, optFns ...func(*Options)) (*ListServiceIndexesOutput, error) 
 ListServiceViews(ctx context.Context, params *ListServiceViewsInput, optFns ...func(*Options)) (*ListServiceViewsOutput, error) 
 ListStreamingAccessForServices(ctx context.Context, params *ListStreamingAccessForServicesInput, optFns ...func(*Options)) (*ListStreamingAccessForServicesOutput, error) 
