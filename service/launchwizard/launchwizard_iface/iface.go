...
type IClient interface {
 ...
 GetDeploymentPatternVersion(ctx context.Context, params *GetDeploymentPatternVersionInput, optFns ...func(*Options)) (*GetDeploymentPatternVersionOutput, error) 
 ...
 ListDeploymentPatternVersions(ctx context.Context, params *ListDeploymentPatternVersionsInput, optFns ...func(*Options)) (*ListDeploymentPatternVersionsOutput, error) 
