...
// CreatePromptRouter provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) CreatePromptRouter(ctx context.Context, params *bedrock.CreatePromptRouterInput, optFns ...func(*bedrock.Options)) (*bedrock.CreatePromptRouterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CreatePromptRouter")
	}

	var r0 *bedrock.CreatePromptRouterOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *bedrock.CreatePromptRouterInput, ...func(*bedrock.Options)) (*bedrock.CreatePromptRouterOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *bedrock.CreatePromptRouterInput, ...func(*bedrock.Options)) *bedrock.CreatePromptRouterOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*bedrock.CreatePromptRouterOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *bedrock.CreatePromptRouterInput, ...func(*bedrock.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// DeletePromptRouter provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) DeletePromptRouter(ctx context.Context, params *bedrock.DeletePromptRouterInput, optFns ...func(*bedrock.Options)) (*bedrock.DeletePromptRouterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for DeletePromptRouter")
	}

	var r0 *bedrock.DeletePromptRouterOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *bedrock.DeletePromptRouterInput, ...func(*bedrock.Options)) (*bedrock.DeletePromptRouterOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *bedrock.DeletePromptRouterInput, ...func(*bedrock.Options)) *bedrock.DeletePromptRouterOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*bedrock.DeletePromptRouterOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *bedrock.DeletePromptRouterInput, ...func(*bedrock.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
