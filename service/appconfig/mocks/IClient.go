...
func (_m *IClient) GetAccountSettings(ctx context.Context, params *appconfig.GetAccountSettingsInput, optFns ...func(*appconfig.Options)) (*appconfig.GetAccountSettingsOutput, error) {
	...
	var r0 *appconfig.GetAccountSettingsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *appconfig.GetAccountSettingsInput, ...func(*appconfig.Options)) (*appconfig.GetAccountSettingsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *appconfig.GetAccountSettingsInput, ...func(*appconfig.Options)) *appconfig.GetAccountSettingsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*appconfig.GetAccountSettingsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *appconfig.GetAccountSettingsInput, ...func(*appconfig.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IClient) UpdateAccountSettings(ctx context.Context, params *appconfig.UpdateAccountSettingsInput, optFns ...func(*appconfig.Options)) (*appconfig.UpdateAccountSettingsOutput, error) {
	...
	var r0 *appconfig.UpdateAccountSettingsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *appconfig.UpdateAccountSettingsInput, ...func(*appconfig.Options)) (*appconfig.UpdateAccountSettingsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *appconfig.UpdateAccountSettingsInput, ...func(*appconfig.Options)) *appconfig.UpdateAccountSettingsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*appconfig.UpdateAccountSettingsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *appconfig.UpdateAccountSettingsInput, ...func(*appconfig.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
