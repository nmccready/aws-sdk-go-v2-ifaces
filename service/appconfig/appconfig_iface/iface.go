...
type IClient interface {
 ...
 CreateExperimentDefinition(ctx context.Context, params *CreateExperimentDefinitionInput, optFns ...func(*Options)) (*CreateExperimentDefinitionOutput, error) 
 ...
 DeleteExperimentDefinition(ctx context.Context, params *DeleteExperimentDefinitionInput, optFns ...func(*Options)) (*DeleteExperimentDefinitionOutput, error) 
 ...
 GetExperimentDefinition(ctx context.Context, params *GetExperimentDefinitionInput, optFns ...func(*Options)) (*GetExperimentDefinitionOutput, error) 
 GetExperimentRun(ctx context.Context, params *GetExperimentRunInput, optFns ...func(*Options)) (*GetExperimentRunOutput, error) 
 ...
 ListExperimentDefinitions(ctx context.Context, params *ListExperimentDefinitionsInput, optFns ...func(*Options)) (*ListExperimentDefinitionsOutput, error) 
 ListExperimentRunEvents(ctx context.Context, params *ListExperimentRunEventsInput, optFns ...func(*Options)) (*ListExperimentRunEventsOutput, error) 
 ListExperimentRuns(ctx context.Context, params *ListExperimentRunsInput, optFns ...func(*Options)) (*ListExperimentRunsOutput, error) 
 ...
 StartExperimentRun(ctx context.Context, params *StartExperimentRunInput, optFns ...func(*Options)) (*StartExperimentRunOutput, error) 
 StopDeployment(ctx context.Context, params *StopDeploymentInput, optFns ...func(*Options)) (*StopDeploymentOutput, error) 
 StopExperimentRun(ctx context.Context, params *StopExperimentRunInput, optFns ...func(*Options)) (*StopExperimentRunOutput, error) 
 ...
 UpdateExperimentDefinition(ctx context.Context, params *UpdateExperimentDefinitionInput, optFns ...func(*Options)) (*UpdateExperimentDefinitionOutput, error) 
 UpdateExperimentRun(ctx context.Context, params *UpdateExperimentRunInput, optFns ...func(*Options)) (*UpdateExperimentRunOutput, error) 
