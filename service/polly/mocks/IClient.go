...
// StartSpeechSynthesisStream provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) StartSpeechSynthesisStream(ctx context.Context, params *polly.StartSpeechSynthesisStreamInput, optFns ...func(*polly.Options)) (*polly.StartSpeechSynthesisStreamOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for StartSpeechSynthesisStream")
	}

	var r0 *polly.StartSpeechSynthesisStreamOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *polly.StartSpeechSynthesisStreamInput, ...func(*polly.Options)) (*polly.StartSpeechSynthesisStreamOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *polly.StartSpeechSynthesisStreamInput, ...func(*polly.Options)) *polly.StartSpeechSynthesisStreamOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*polly.StartSpeechSynthesisStreamOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *polly.StartSpeechSynthesisStreamInput, ...func(*polly.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
