...
// ListRecommendationsForResource provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListRecommendationsForResource(ctx context.Context, params *trustedadvisor.ListRecommendationsForResourceInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListRecommendationsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListRecommendationsForResource")
	}

	var r0 *trustedadvisor.ListRecommendationsForResourceOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *trustedadvisor.ListRecommendationsForResourceInput, ...func(*trustedadvisor.Options)) (*trustedadvisor.ListRecommendationsForResourceOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *trustedadvisor.ListRecommendationsForResourceInput, ...func(*trustedadvisor.Options)) *trustedadvisor.ListRecommendationsForResourceOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*trustedadvisor.ListRecommendationsForResourceOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *trustedadvisor.ListRecommendationsForResourceInput, ...func(*trustedadvisor.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
