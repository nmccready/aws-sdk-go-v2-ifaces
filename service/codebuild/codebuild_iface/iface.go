...
type IClient interface {
 ...
 BatchGetCommandExecutions(ctx context.Context, params *BatchGetCommandExecutionsInput, optFns ...func(*Options)) (*BatchGetCommandExecutionsOutput, error) 
 ...
 BatchGetSandboxes(ctx context.Context, params *BatchGetSandboxesInput, optFns ...func(*Options)) (*BatchGetSandboxesOutput, error) 
 ...
 ListCommandExecutionsForSandbox(ctx context.Context, params *ListCommandExecutionsForSandboxInput, optFns ...func(*Options)) (*ListCommandExecutionsForSandboxOutput, error) 
 ...
 ListSandboxes(ctx context.Context, params *ListSandboxesInput, optFns ...func(*Options)) (*ListSandboxesOutput, error) 
 ListSandboxesForProject(ctx context.Context, params *ListSandboxesForProjectInput, optFns ...func(*Options)) (*ListSandboxesForProjectOutput, error) 
 ...
 StartSandbox(ctx context.Context, params *StartSandboxInput, optFns ...func(*Options)) (*StartSandboxOutput, error) 
 StartSandboxConnection(ctx context.Context, params *StartSandboxConnectionInput, optFns ...func(*Options)) (*StartSandboxConnectionOutput, error) 
 ...
 StopSandbox(ctx context.Context, params *StopSandboxInput, optFns ...func(*Options)) (*StopSandboxOutput, error) 
