...
// GetPlayerConnectionDetails provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetPlayerConnectionDetails(ctx context.Context, params *gamelift.GetPlayerConnectionDetailsInput, optFns ...func(*gamelift.Options)) (*gamelift.GetPlayerConnectionDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPlayerConnectionDetails")
	}

	var r0 *gamelift.GetPlayerConnectionDetailsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gamelift.GetPlayerConnectionDetailsInput, ...func(*gamelift.Options)) (*gamelift.GetPlayerConnectionDetailsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gamelift.GetPlayerConnectionDetailsInput, ...func(*gamelift.Options)) *gamelift.GetPlayerConnectionDetailsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gamelift.GetPlayerConnectionDetailsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *gamelift.GetPlayerConnectionDetailsInput, ...func(*gamelift.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
