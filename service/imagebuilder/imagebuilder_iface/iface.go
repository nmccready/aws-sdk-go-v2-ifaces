...
type IClient interface {
 ...
 DistributeImage(ctx context.Context, params *DistributeImageInput, optFns ...func(*Options)) (*DistributeImageOutput, error) 
 ...
 RetryImage(ctx context.Context, params *RetryImageInput, optFns ...func(*Options)) (*RetryImageOutput, error) 
