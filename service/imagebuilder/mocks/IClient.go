...
func (_m *IClient) GetMarketplaceResource(ctx context.Context, params *imagebuilder.GetMarketplaceResourceInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetMarketplaceResourceOutput, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMarketplaceResource")
	}

	var r0 *imagebuilder.GetMarketplaceResourceOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *imagebuilder.GetMarketplaceResourceInput, ...func(*imagebuilder.Options)) (*imagebuilder.GetMarketplaceResourceOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *imagebuilder.GetMarketplaceResourceInput, ...func(*imagebuilder.Options)) *imagebuilder.GetMarketplaceResourceOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*imagebuilder.GetMarketplaceResourceOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *imagebuilder.GetMarketplaceResourceInput, ...func(*imagebuilder.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IClient) ImportDiskImage(ctx context.Context, params *imagebuilder.ImportDiskImageInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ImportDiskImageOutput, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ImportDiskImage")
	}

	var r0 *imagebuilder.ImportDiskImageOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *imagebuilder.ImportDiskImageInput, ...func(*imagebuilder.Options)) (*imagebuilder.ImportDiskImageOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *imagebuilder.ImportDiskImageInput, ...func(*imagebuilder.Options)) *imagebuilder.ImportDiskImageOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*imagebuilder.ImportDiskImageOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *imagebuilder.ImportDiskImageInput, ...func(*imagebuilder.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
