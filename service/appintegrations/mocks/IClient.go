...
// CreateDataIntegrationAssociation provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) CreateDataIntegrationAssociation(ctx context.Context, params *appintegrations.CreateDataIntegrationAssociationInput, optFns ...func(*appintegrations.Options)) (*appintegrations.CreateDataIntegrationAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateDataIntegrationAssociation")
	}

	var r0 *appintegrations.CreateDataIntegrationAssociationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *appintegrations.CreateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) (*appintegrations.CreateDataIntegrationAssociationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *appintegrations.CreateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) *appintegrations.CreateDataIntegrationAssociationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*appintegrations.CreateDataIntegrationAssociationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *appintegrations.CreateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateDataIntegrationAssociation provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateDataIntegrationAssociation(ctx context.Context, params *appintegrations.UpdateDataIntegrationAssociationInput, optFns ...func(*appintegrations.Options)) (*appintegrations.UpdateDataIntegrationAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateDataIntegrationAssociation")
	}

	var r0 *appintegrations.UpdateDataIntegrationAssociationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *appintegrations.UpdateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) (*appintegrations.UpdateDataIntegrationAssociationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *appintegrations.UpdateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) *appintegrations.UpdateDataIntegrationAssociationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*appintegrations.UpdateDataIntegrationAssociationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *appintegrations.UpdateDataIntegrationAssociationInput, ...func(*appintegrations.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
