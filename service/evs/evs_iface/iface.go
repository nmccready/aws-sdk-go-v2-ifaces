...
type IClient interface {
 ...
 CreateEnvironmentConnector(ctx context.Context, params *CreateEnvironmentConnectorInput, optFns ...func(*Options)) (*CreateEnvironmentConnectorOutput, error) 
 ...
 DeleteEnvironmentConnector(ctx context.Context, params *DeleteEnvironmentConnectorInput, optFns ...func(*Options)) (*DeleteEnvironmentConnectorOutput, error) 
 ...
 GetDepotUrl(ctx context.Context, params *GetDepotUrlInput, optFns ...func(*Options)) (*GetDepotUrlOutput, error) 
 ...
 ListEnvironmentConnectors(ctx context.Context, params *ListEnvironmentConnectorsInput, optFns ...func(*Options)) (*ListEnvironmentConnectorsOutput, error) 
 ...
 ListVmEntitlements(ctx context.Context, params *ListVmEntitlementsInput, optFns ...func(*Options)) (*ListVmEntitlementsOutput, error) 
 TagResource(ctx context.Context, params *TagResourceInput, optFns ...func(*Options)) (*TagResourceOutput, error) 
 UntagResource(ctx context.Context, params *UntagResourceInput, optFns ...func(*Options)) (*UntagResourceOutput, error) 
 UpdateEnvironmentConnector(ctx context.Context, params *UpdateEnvironmentConnectorInput, optFns ...func(*Options)) (*UpdateEnvironmentConnectorOutput, error) 
}
