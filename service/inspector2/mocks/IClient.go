...
// GetClustersForImage provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetClustersForImage(ctx context.Context, params *inspector2.GetClustersForImageInput, optFns ...func(*inspector2.Options)) (*inspector2.GetClustersForImageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetClustersForImage")
	}

	var r0 *inspector2.GetClustersForImageOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *inspector2.GetClustersForImageInput, ...func(*inspector2.Options)) (*inspector2.GetClustersForImageOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *inspector2.GetClustersForImageInput, ...func(*inspector2.Options)) *inspector2.GetClustersForImageOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*inspector2.GetClustersForImageOutput)
		}
	}
