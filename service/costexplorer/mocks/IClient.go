...
// ListCostCategoryResourceAssociations provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListCostCategoryResourceAssociations(ctx context.Context, params *costexplorer.ListCostCategoryResourceAssociationsInput, optFns ...func(*costexplorer.Options)) (*costexplorer.ListCostCategoryResourceAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListCostCategoryResourceAssociations")
	}

	var r0 *costexplorer.ListCostCategoryResourceAssociationsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *costexplorer.ListCostCategoryResourceAssociationsInput, ...func(*costexplorer.Options)) (*costexplorer.ListCostCategoryResourceAssociationsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *costexplorer.ListCostCategoryResourceAssociationsInput, ...func(*costexplorer.Options)) *costexplorer.ListCostCategoryResourceAssociationsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*costexplorer.ListCostCategoryResourceAssociationsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *costexplorer.ListCostCategoryResourceAssociationsInput, ...func(*costexplorer.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
