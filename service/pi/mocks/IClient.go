...
// ListPerformanceAnalysisReportRecommendations provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListPerformanceAnalysisReportRecommendations(ctx context.Context, params *pi.ListPerformanceAnalysisReportRecommendationsInput, optFns ...func(*pi.Options)) (*pi.ListPerformanceAnalysisReportRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListPerformanceAnalysisReportRecommendations")
	}

	var r0 *pi.ListPerformanceAnalysisReportRecommendationsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *pi.ListPerformanceAnalysisReportRecommendationsInput, ...func(*pi.Options)) (*pi.ListPerformanceAnalysisReportRecommendationsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pi.ListPerformanceAnalysisReportRecommendationsInput, ...func(*pi.Options)) *pi.ListPerformanceAnalysisReportRecommendationsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pi.ListPerformanceAnalysisReportRecommendationsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *pi.ListPerformanceAnalysisReportRecommendationsInput, ...func(*pi.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
