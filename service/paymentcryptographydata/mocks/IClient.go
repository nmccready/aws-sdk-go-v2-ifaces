...
// GenerateAs2805KekValidation provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GenerateAs2805KekValidation(ctx context.Context, params *paymentcryptographydata.GenerateAs2805KekValidationInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateAs2805KekValidationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GenerateAs2805KekValidation")
	}

	var r0 *paymentcryptographydata.GenerateAs2805KekValidationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *paymentcryptographydata.GenerateAs2805KekValidationInput, ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateAs2805KekValidationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *paymentcryptographydata.GenerateAs2805KekValidationInput, ...func(*paymentcryptographydata.Options)) *paymentcryptographydata.GenerateAs2805KekValidationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*paymentcryptographydata.GenerateAs2805KekValidationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *paymentcryptographydata.GenerateAs2805KekValidationInput, ...func(*paymentcryptographydata.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// GenerateAuthRequestCryptogram provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GenerateAuthRequestCryptogram(ctx context.Context, params *paymentcryptographydata.GenerateAuthRequestCryptogramInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateAuthRequestCryptogramOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GenerateAuthRequestCryptogram")
	}

	var r0 *paymentcryptographydata.GenerateAuthRequestCryptogramOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *paymentcryptographydata.GenerateAuthRequestCryptogramInput, ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateAuthRequestCryptogramOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *paymentcryptographydata.GenerateAuthRequestCryptogramInput, ...func(*paymentcryptographydata.Options)) *paymentcryptographydata.GenerateAuthRequestCryptogramOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*paymentcryptographydata.GenerateAuthRequestCryptogramOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *paymentcryptographydata.GenerateAuthRequestCryptogramInput, ...func(*paymentcryptographydata.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
