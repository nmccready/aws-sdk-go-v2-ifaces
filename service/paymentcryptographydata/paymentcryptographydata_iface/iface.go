...
package paymentcryptographydata_iface
...
type IClient interface {
 ...
 GenerateAuthRequestCryptogram(ctx context.Context, params *GenerateAuthRequestCryptogramInput, optFns ...func(*Options)) (*GenerateAuthRequestCryptogramOutput, error) 
