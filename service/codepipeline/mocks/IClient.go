...
// ListDeployActionExecutionTargets provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) ListDeployActionExecutionTargets(ctx context.Context, params *codepipeline.ListDeployActionExecutionTargetsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListDeployActionExecutionTargetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListDeployActionExecutionTargets")
	}

	var r0 *codepipeline.ListDeployActionExecutionTargetsOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *codepipeline.ListDeployActionExecutionTargetsInput, ...func(*codepipeline.Options)) (*codepipeline.ListDeployActionExecutionTargetsOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *codepipeline.ListDeployActionExecutionTargetsInput, ...func(*codepipeline.Options)) *codepipeline.ListDeployActionExecutionTargetsOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*codepipeline.ListDeployActionExecutionTargetsOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *codepipeline.ListDeployActionExecutionTargetsInput, ...func(*codepipeline.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
