...
type IClient interface {
 ...
 CreateDataflowEndpointGroupV2(ctx context.Context, params *CreateDataflowEndpointGroupV2Input, optFns ...func(*Options)) (*CreateDataflowEndpointGroupV2Output, error) 
 ...
 DescribeContactVersion(ctx context.Context, params *DescribeContactVersionInput, optFns ...func(*Options)) (*DescribeContactVersionOutput, error) 
 ...
 GetAgentTaskResponseUrl(ctx context.Context, params *GetAgentTaskResponseUrlInput, optFns ...func(*Options)) (*GetAgentTaskResponseUrlOutput, error) 
 ...
 ListAntennas(ctx context.Context, params *ListAntennasInput, optFns ...func(*Options)) (*ListAntennasOutput, error) 
 ListConfigs(ctx context.Context, params *ListConfigsInput, optFns ...func(*Options)) (*ListConfigsOutput, error) 
 ListContactVersions(ctx context.Context, params *ListContactVersionsInput, optFns ...func(*Options)) (*ListContactVersionsOutput, error) 
 ...
 ListGroundStationReservations(ctx context.Context, params *ListGroundStationReservationsInput, optFns ...func(*Options)) (*ListGroundStationReservationsOutput, error) 
