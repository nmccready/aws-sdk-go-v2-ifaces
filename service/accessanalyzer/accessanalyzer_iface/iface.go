...
type IClient interface {
 ...
 CreateServiceLinkedAnalyzer(ctx context.Context, params *CreateServiceLinkedAnalyzerInput, optFns ...func(*Options)) (*CreateServiceLinkedAnalyzerOutput, error) 
 ...
 DeleteServiceLinkedAnalyzer(ctx context.Context, params *DeleteServiceLinkedAnalyzerInput, optFns ...func(*Options)) (*DeleteServiceLinkedAnalyzerOutput, error) 
 ...
 UpdateAnalyzer(ctx context.Context, params *UpdateAnalyzerInput, optFns ...func(*Options)) (*UpdateAnalyzerOutput, error) 
