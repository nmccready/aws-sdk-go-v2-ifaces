...
type IClient interface {
 ...
 DeleteFeedPolicy(ctx context.Context, params *DeleteFeedPolicyInput, optFns ...func(*Options)) (*DeleteFeedPolicyOutput, error) 
 ...
 GetFeedPolicy(ctx context.Context, params *GetFeedPolicyInput, optFns ...func(*Options)) (*GetFeedPolicyOutput, error) 
 ...
 PutFeedPolicy(ctx context.Context, params *PutFeedPolicyInput, optFns ...func(*Options)) (*PutFeedPolicyOutput, error) 
