...
// DescribeDirectoryDataAccess provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) DescribeDirectoryDataAccess(ctx context.Context, params *directoryservice.DescribeDirectoryDataAccessInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeDirectoryDataAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for DescribeDirectoryDataAccess")
	}

	var r0 *directoryservice.DescribeDirectoryDataAccessOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.DescribeDirectoryDataAccessInput, ...func(*directoryservice.Options)) (*directoryservice.DescribeDirectoryDataAccessOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.DescribeDirectoryDataAccessInput, ...func(*directoryservice.Options)) *directoryservice.DescribeDirectoryDataAccessOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*directoryservice.DescribeDirectoryDataAccessOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *directoryservice.DescribeDirectoryDataAccessInput, ...func(*directoryservice.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// DisableDirectoryDataAccess provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) DisableDirectoryDataAccess(ctx context.Context, params *directoryservice.DisableDirectoryDataAccessInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DisableDirectoryDataAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for DisableDirectoryDataAccess")
	}

	var r0 *directoryservice.DisableDirectoryDataAccessOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.DisableDirectoryDataAccessInput, ...func(*directoryservice.Options)) (*directoryservice.DisableDirectoryDataAccessOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.DisableDirectoryDataAccessInput, ...func(*directoryservice.Options)) *directoryservice.DisableDirectoryDataAccessOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*directoryservice.DisableDirectoryDataAccessOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *directoryservice.DisableDirectoryDataAccessInput, ...func(*directoryservice.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// EnableDirectoryDataAccess provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) EnableDirectoryDataAccess(ctx context.Context, params *directoryservice.EnableDirectoryDataAccessInput, optFns ...func(*directoryservice.Options)) (*directoryservice.EnableDirectoryDataAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for EnableDirectoryDataAccess")
	}

	var r0 *directoryservice.EnableDirectoryDataAccessOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.EnableDirectoryDataAccessInput, ...func(*directoryservice.Options)) (*directoryservice.EnableDirectoryDataAccessOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *directoryservice.EnableDirectoryDataAccessInput, ...func(*directoryservice.Options)) *directoryservice.EnableDirectoryDataAccessOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*directoryservice.EnableDirectoryDataAccessOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *directoryservice.EnableDirectoryDataAccessInput, ...func(*directoryservice.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
