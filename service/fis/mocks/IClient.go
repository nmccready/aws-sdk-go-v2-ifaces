...
// GetSafetyLever provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) GetSafetyLever(ctx context.Context, params *fis.GetSafetyLeverInput, optFns ...func(*fis.Options)) (*fis.GetSafetyLeverOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetSafetyLever")
	}

	var r0 *fis.GetSafetyLeverOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *fis.GetSafetyLeverInput, ...func(*fis.Options)) (*fis.GetSafetyLeverOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *fis.GetSafetyLeverInput, ...func(*fis.Options)) *fis.GetSafetyLeverOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*fis.GetSafetyLeverOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *fis.GetSafetyLeverInput, ...func(*fis.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateSafetyLeverState provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateSafetyLeverState(ctx context.Context, params *fis.UpdateSafetyLeverStateInput, optFns ...func(*fis.Options)) (*fis.UpdateSafetyLeverStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateSafetyLeverState")
	}

	var r0 *fis.UpdateSafetyLeverStateOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *fis.UpdateSafetyLeverStateInput, ...func(*fis.Options)) (*fis.UpdateSafetyLeverStateOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *fis.UpdateSafetyLeverStateInput, ...func(*fis.Options)) *fis.UpdateSafetyLeverStateOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*fis.UpdateSafetyLeverStateOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *fis.UpdateSafetyLeverStateInput, ...func(*fis.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
