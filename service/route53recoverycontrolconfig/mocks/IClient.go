...
func (_m *IClient) UpdateCluster(ctx context.Context, params *route53recoverycontrolconfig.UpdateClusterInput, optFns ...func(*route53recoverycontrolconfig.Options)) (*route53recoverycontrolconfig.UpdateClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *route53recoverycontrolconfig.UpdateClusterOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *route53recoverycontrolconfig.UpdateClusterInput, ...func(*route53recoverycontrolconfig.Options)) (*route53recoverycontrolconfig.UpdateClusterOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *route53recoverycontrolconfig.UpdateClusterInput, ...func(*route53recoverycontrolconfig.Options)) *route53recoverycontrolconfig.UpdateClusterOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*route53recoverycontrolconfig.UpdateClusterOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *route53recoverycontrolconfig.UpdateClusterInput, ...func(*route53recoverycontrolconfig.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
