...
// UpdateManagedNotificationChannelAssociation provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) UpdateManagedNotificationChannelAssociation(ctx context.Context, params *notifications.UpdateManagedNotificationChannelAssociationInput, optFns ...func(*notifications.Options)) (*notifications.UpdateManagedNotificationChannelAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateManagedNotificationChannelAssociation")
	}

	var r0 *notifications.UpdateManagedNotificationChannelAssociationOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *notifications.UpdateManagedNotificationChannelAssociationInput, ...func(*notifications.Options)) (*notifications.UpdateManagedNotificationChannelAssociationOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *notifications.UpdateManagedNotificationChannelAssociationInput, ...func(*notifications.Options)) *notifications.UpdateManagedNotificationChannelAssociationOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*notifications.UpdateManagedNotificationChannelAssociationOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *notifications.UpdateManagedNotificationChannelAssociationInput, ...func(*notifications.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
