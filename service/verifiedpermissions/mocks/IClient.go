...
func (_m *IClient) ListTagsForResource(ctx context.Context, params *verifiedpermissions.ListTagsForResourceInput, optFns ...func(*verifiedpermissions.Options)) (*verifiedpermissions.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *verifiedpermissions.ListTagsForResourceOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.ListTagsForResourceInput, ...func(*verifiedpermissions.Options)) (*verifiedpermissions.ListTagsForResourceOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.ListTagsForResourceInput, ...func(*verifiedpermissions.Options)) *verifiedpermissions.ListTagsForResourceOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*verifiedpermissions.ListTagsForResourceOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *verifiedpermissions.ListTagsForResourceInput, ...func(*verifiedpermissions.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IClient) TagResource(ctx context.Context, params *verifiedpermissions.TagResourceInput, optFns ...func(*verifiedpermissions.Options)) (*verifiedpermissions.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *verifiedpermissions.TagResourceOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.TagResourceInput, ...func(*verifiedpermissions.Options)) (*verifiedpermissions.TagResourceOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.TagResourceInput, ...func(*verifiedpermissions.Options)) *verifiedpermissions.TagResourceOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*verifiedpermissions.TagResourceOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *verifiedpermissions.TagResourceInput, ...func(*verifiedpermissions.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IClient) UntagResource(ctx context.Context, params *verifiedpermissions.UntagResourceInput, optFns ...func(*verifiedpermissions.Options)) (*verifiedpermissions.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	var r0 *verifiedpermissions.UntagResourceOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.UntagResourceInput, ...func(*verifiedpermissions.Options)) (*verifiedpermissions.UntagResourceOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *verifiedpermissions.UntagResourceInput, ...func(*verifiedpermissions.Options)) *verifiedpermissions.UntagResourceOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*verifiedpermissions.UntagResourceOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *verifiedpermissions.UntagResourceInput, ...func(*verifiedpermissions.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
