...
package verifiedpermissions_iface
...
type IClient interface {
 ...
 CreatePolicyStoreAlias(ctx context.Context, params *CreatePolicyStoreAliasInput, optFns ...func(*Options)) (*CreatePolicyStoreAliasOutput, error) 
 ...
 DeletePolicyStoreAlias(ctx context.Context, params *DeletePolicyStoreAliasInput, optFns ...func(*Options)) (*DeletePolicyStoreAliasOutput, error) 
 ...
 GetPolicyStoreAlias(ctx context.Context, params *GetPolicyStoreAliasInput, optFns ...func(*Options)) (*GetPolicyStoreAliasOutput, error) 
 ...
 ListPolicyStoreAliases(ctx context.Context, params *ListPolicyStoreAliasesInput, optFns ...func(*Options)) (*ListPolicyStoreAliasesOutput, error) 
