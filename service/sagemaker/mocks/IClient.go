...
// StartClusterHealthCheck provides a mock function with given fields: ctx, params, optFns
func (_m *IClient) StartClusterHealthCheck(ctx context.Context, params *sagemaker.StartClusterHealthCheckInput, optFns ...func(*sagemaker.Options)) (*sagemaker.StartClusterHealthCheckOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for StartClusterHealthCheck")
	}

	var r0 *sagemaker.StartClusterHealthCheckOutput
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *sagemaker.StartClusterHealthCheckInput, ...func(*sagemaker.Options)) (*sagemaker.StartClusterHealthCheckOutput, error)); ok {
		return rf(ctx, params, optFns...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *sagemaker.StartClusterHealthCheckInput, ...func(*sagemaker.Options)) *sagemaker.StartClusterHealthCheckOutput); ok {
		r0 = rf(ctx, params, optFns...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*sagemaker.StartClusterHealthCheckOutput)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *sagemaker.StartClusterHealthCheckInput, ...func(*sagemaker.Options)) error); ok {
		r1 = rf(ctx, params, optFns...)
	} else {
		r1 = ret.Error(1)
	}
