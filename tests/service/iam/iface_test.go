...
func TestIClient(t *testing.T) {
    ...
    t.Run("TestAcceptDelegationRequest", func(t *testing.T) {
        input := &iam.AcceptDelegationRequestInput{}
        output := &iam.AcceptDelegationRequestOutput{}

        mockClient.On("AcceptDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.AcceptDelegationRequest(ctx, input)
    ...
    t.Run("TestAssociateDelegationRequest", func(t *testing.T) {
        input := &iam.AssociateDelegationRequestInput{}
        output := &iam.AssociateDelegationRequestOutput{}

        mockClient.On("AssociateDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.AssociateDelegationRequest(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestCreateDelegationRequest", func(t *testing.T) {
        input := &iam.CreateDelegationRequestInput{}
        output := &iam.CreateDelegationRequestOutput{}

        mockClient.On("CreateDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.CreateDelegationRequest(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestDisableOutboundWebIdentityFederation", func(t *testing.T) {
        input := &iam.DisableOutboundWebIdentityFederationInput{}
        output := &iam.DisableOutboundWebIdentityFederationOutput{}

        mockClient.On("DisableOutboundWebIdentityFederation", ctx, input).Return(output, nil)

        result, err := mockClient.DisableOutboundWebIdentityFederation(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestEnableOutboundWebIdentityFederation", func(t *testing.T) {
        input := &iam.EnableOutboundWebIdentityFederationInput{}
        output := &iam.EnableOutboundWebIdentityFederationOutput{}

        mockClient.On("EnableOutboundWebIdentityFederation", ctx, input).Return(output, nil)

        result, err := mockClient.EnableOutboundWebIdentityFederation(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestGetDelegationRequest", func(t *testing.T) {
        input := &iam.GetDelegationRequestInput{}
        output := &iam.GetDelegationRequestOutput{}

        mockClient.On("GetDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.GetDelegationRequest(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestGetHumanReadableSummary", func(t *testing.T) {
        input := &iam.GetHumanReadableSummaryInput{}
        output := &iam.GetHumanReadableSummaryOutput{}

        mockClient.On("GetHumanReadableSummary", ctx, input).Return(output, nil)

        result, err := mockClient.GetHumanReadableSummary(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestGetOutboundWebIdentityFederationInfo", func(t *testing.T) {
        input := &iam.GetOutboundWebIdentityFederationInfoInput{}
        output := &iam.GetOutboundWebIdentityFederationInfoOutput{}

        mockClient.On("GetOutboundWebIdentityFederationInfo", ctx, input).Return(output, nil)

        result, err := mockClient.GetOutboundWebIdentityFederationInfo(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestListDelegationRequests", func(t *testing.T) {
        input := &iam.ListDelegationRequestsInput{}
        output := &iam.ListDelegationRequestsOutput{}

        mockClient.On("ListDelegationRequests", ctx, input).Return(output, nil)

        result, err := mockClient.ListDelegationRequests(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestRejectDelegationRequest", func(t *testing.T) {
        input := &iam.RejectDelegationRequestInput{}
        output := &iam.RejectDelegationRequestOutput{}

        mockClient.On("RejectDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.RejectDelegationRequest(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestSendDelegationToken", func(t *testing.T) {
        input := &iam.SendDelegationTokenInput{}
        output := &iam.SendDelegationTokenOutput{}

        mockClient.On("SendDelegationToken", ctx, input).Return(output, nil)

        result, err := mockClient.SendDelegationToken(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
    ...
    t.Run("TestUpdateDelegationRequest", func(t *testing.T) {
        input := &iam.UpdateDelegationRequestInput{}
        output := &iam.UpdateDelegationRequestOutput{}

        mockClient.On("UpdateDelegationRequest", ctx, input).Return(output, nil)

        result, err := mockClient.UpdateDelegationRequest(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
