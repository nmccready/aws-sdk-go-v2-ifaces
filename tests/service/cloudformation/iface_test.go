...
func TestIClient(t *testing.T) {
    ...
    t.Run("TestDescribeEvents", func(t *testing.T) {
        ...
        output := &cloudformation.DescribeEventsOutput{}
    ...
    t.Run("TestGetHookResult", func(t *testing.T) {
        input := &cloudformation.GetHookResultInput{}
        output := &cloudformation.GetHookResultOutput{}

        mockClient.On("GetHookResult", ctx, input).Return(output, nil)

        result, err := mockClient.GetHookResult(ctx, input)
        assert.NoError(t, err)
        assert.Equal(t, output, result)
